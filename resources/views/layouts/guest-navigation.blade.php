<nav class="navbar navbar-expand-lg shadow-md py-2 bg-white relative flex items-center w-full justify-between">
  <div class="px-6 w-full flex flex-wrap items-center justify-between">
    <div class="flex items-center">
      ...
      <a class="navbar-brand text-indigo-600" href="#!">
      ...
      <ul class="navbar-nav mr-auto lg:flex lg:flex-row">
        <li class="nav-item">
          ...
          hover:text-indigo-700 focus:text-indigo-700 transition duration-150 ease-in-out" 
            href="{{ url('/') }}" data-mdb-ripple="true" data-mdb-ripple-color="light">TMS</a>
        </li>
        <li class="nav-item">
          <a class="nav-link block pr-2 lg:px-2 py-2 {{ request()->routeIs('about') ? 'text-indigo-600' : 'text-gray-600' }} 
          hover:text-indigo-700 focus:text-indigo-700 transition duration-150 ease-in-out" 
            href="{{ url('/about') }}" data-mdb-ripple="true" data-mdb-ripple-color="light" >About Us</a>
        </li>
        <li class="nav-item mb-2 lg:mb-0">
          <a class="nav-link block pr-2 lg:px-2 py-2 {{ request()->routeIs('courses') ? 'text-indigo-600' : 'text-gray-600' }}
          hover:text-indigo-700 focus:text-indigo-700 transition duration-150 ease-in-out" 
            href="{{ url('/courses') }}" data-mdb-ripple="true" data-mdb-ripple-color="light" >Browse Courses</a>
        </li>
        <li class="nav-item">
          <a class="nav-link block pr-2 lg:px-2 py-2 {{ request()->routeIs('contact') ? 'text-indigo-600' : 'text-gray-600' }}
          hover:text-indigo-700 focus:text-indigo-700 transition duration-150 ease-in-out" 
            href="{{ url('/contact') }}" data-mdb-ripple="true" data-mdb-ripple-color="light" >Contact Us</a>
        </li>
      </ul>
    </div>
    <div class="flex items-center lg:ml-auto">
      @if (Route::has('login'))
        ...
        @else
          <a href="{{ route('login') }}">
            <x-forms.button-secondary class="px-6 py-2.5 text-xs uppercase mr-2">
                Login
            </x-forms.button-secondary>
          </a>
          <a href="{{ route('register') }}">
            <x-forms.button-primary class="px-6 py-2.5 text-xs uppercase">
                Register
            </x-forms.button-primary>
          </a>
        @endauth
