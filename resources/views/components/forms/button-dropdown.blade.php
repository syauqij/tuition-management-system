@props(['name' => 'Action', 'id' => 'dropdownMenu', 'colour' => 'bg-gray-700'])
...
<div class="dropdown relative inline-block">
  <a class="dropdown-toggle px-6 py-2.5 {{$colour}} text-white font-medium text-xs leading-tight uppercase rounded
