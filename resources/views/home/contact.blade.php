...
<x-guest-layout>
  <div class="container px-5 py-20 mx-auto">
    <div class="flex flex-wrap w-full flex-col mb-10 items-center text-center">
      <h1 class="text-5xl xl:text-6xl font-bold tracking-tight mb-12">Let's Have a Talk</h1>
      <p class="lg:w-4/5 w-full leading-relaxed text-gray-500 text-xl">
        If you have any enquiries regarding any of our services, feel free to get in touch.
      </p>
    </div>
    ...
    <div class="block rounded-lg shadow-lg bg-white">
      <div class="flex flex-wrap items-center">
        <div class="grow-0 shrink-0 basis-auto block w-full lg:flex lg:w-5/12">
          <div class="map-container-2 w-full h">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3984.6379218435236!2d101.63431081465083!3d2.9200457553328847!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31cdb72c965ab4cd%3A0x38201f285c241048!2sTamarind%20Square!5e0!3m2!1sen!2smy!4v1668787569939!5m2!1sen!2smy" class="left-0 top-0 h-full w-full rounded-t-lg lg:rounded-tr-none lg:rounded-bl-lg" frameborder="0" allowfullscreen></iframe>
          </div>
        </div>
            ...
            <div class="mb-12 grow-0 shrink-0 basis-auto w-full md:w-6/12 lg:w-full xl:w-6/12 px-3 md:px-6 xl:px-12">
              <div class="flex items-start">
                ...
                <div class="grow ml-6">
                  ...
                  <p class="text-gray-500">support@tuitionplus.my</p>                      
                </div>
              </div>
            </div>
            <div class="mb-12 grow-0 shrink-0 basis-auto w-full md:w-6/12 lg:w-full xl:w-6/12 px-3 md:px-6 xl:px-12">
              <div class="flex items-start">
                ...
                <div class="grow ml-6">
                  ...
                  <p class="text-gray-500">sales@tuitionplus.my</p>                      
                </div>
              </div>
            </div>
            <div class="mb-12 grow-0 shrink-0 basis-auto w-full md:w-6/12 lg:w-full xl:w-6/12 px-3 md:px-6 xl:px-12">
              <div class="flex align-start">
                ...
                <div class="grow ml-6">
                  ...
                  <p class="text-gray-500">press@tuitionplus.my</p>                      
                </div>
              </div>
            </div>
            <div class="mb-12 lg:mb-0 grow-0 shrink-0 basis-auto w-full md:w-6/12 lg:w-full xl:w-6/12 px-3 md:px-6 xl:px-12">
              <div class="flex align-start">
                ...
                <div class="grow ml-6">
                  ...
                  <p class="text-gray-500">bugs@tuitionplus.my</p>                      
                </div>
              </div>
            </div>

            <div class="p-2 w-full pt-8 border-t border-gray-200 text-center">
              <p class="leading-normal my-5">B-02-03, Tamarind Square,
                <br>Cyberjaya, 63000 Cyberjaya, Selangor
                <br>+603 2241 8888
              </p>
